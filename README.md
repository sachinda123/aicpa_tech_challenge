...
Replace <container_id> with the actual ID from the previous step.
Inside the container, run:
bash
Copy code
npm run test
This will execute the test suite, and the results will be displayed in the terminal. Ensure that your test framework (e.g., Jest) is properly configured to run within the Docker environment.
DOCKER DOCUMENTATION 2. Production Mode
